...
python main.py \
    --coco_path ../RLIPv2/data/coco2017 \
    --coco_rel_anno_file ../RLIPv2/data/coco2017/annotations/RLIPv2_train2017_threshold20_Tagger2_Noi24_20e_Xattnmask_SceneGraph_model_large_caption_nucleus10_thre05.json \
    --coco_det_file ../RLIPv2/data/coco2017/internimage/formatted_results.json \
