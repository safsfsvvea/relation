...
if __name__ == '__main__':
  ...
  #                    ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/ParSeD_vcoco.pickle',
  #                    ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/ParSeD_vcoco_vg_v1.pickle',
  #                    ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIP_ParSeD_vcoco.pickle',
  #                    ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIP_ParSeD_vcoco_COCO_Init.pickle',
  #                    ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIP_ParSe_vcoco_WordsV3.pickle',
  #                    ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIP_ParSe_MDETR_R101_vcoco_WordsV3.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/ParSeD_vcoco_vg_v1_unimodal_relation_detection.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/ParSe_R101_vcoco_pnms_2.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/ParSe_R101_vcoco_pnms.pickle',
  #                      ovr_thresh=0.5)
  
  ### RLIPv2 paper VCOCO
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PDA_v2_VCOCO_R50_VG.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PDA_v2_VCOCO_R50_VGCOCO.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PDA_v2_VCOCO_R50_VGCOCOO365.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PDA_v2_VCOCO_SwinT_VGCOCOO365.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PDA_v2_VCOCO_SwinL_VGCOCOO365.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PD_v2_VCOCO_R50_VGCOCOO365.pickle',
  #                      ovr_thresh=0.5)
  # vcocoeval._do_eval('/Path/To/jacob/VCOCO_pickle/RLIPv2/RLIP_PD_v2_VCOCO_R50_VG.pickle',
  #                      ovr_thresh=0.5)
