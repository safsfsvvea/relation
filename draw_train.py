...
# 使用示例
json_file = '/bd_byt4090i1/users/clin/RLIPv2/hico_20160224_det/annotations/trainval_hico.json'
output_dir = '/bd_byt4090i1/users/clin/relation/results/train_annotations_test'
